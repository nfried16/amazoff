...
INSERT INTO Product(name, description, image, category, creator)
    VALUES(
    ('Ball', 'This is a ball', decode('02135ae433f2324523d', 'hex'), 'Sports', (SELECT id from Seller)),
    ('Hat', 'This is a hat', decode('02135ae433f2324523e', 'hex'), 'Clothing', (SELECT id from Seller)),
    ('Water Bottle', 'This is a water bottle', decode('02135ae433f2324523a', 'hex'), 'Sports', (SELECT id from Seller)),
    ('iPhone', 'This is an iPhone 12', decode('02135ae433f2324523b', 'hex'), 'Electronics', (SELECT id from Seller)),
    ('Detergent', 'This is detergent', decode('02135ae433f2324523c', 'hex'), 'Household Items', (SELECT id from Seller)),
    ('Barbie', 'This is a Barbie doll', decode('02135ae433f2324524e', 'hex'), 'Leisure', (SELECT id from Seller))
    );

-- SellerProduct
INSERT INTO SellerProduct VALUES((SELECT id FROM Seller), (SELECT id FROM Product WHERE name='Ball'), 0, 45.40);
...
-- OrderItem
INSERT INTO OrderItem(user_id, seller_id, product_id, product_id, amount, price)
    VALUES(
...
INSERT INTO ProductReview(user_id, product_id, rating, title, description, date)
    ...
    ((SELECT id FROM Users WHERE email='natty@gmail.com'), (SELECT id FROM Product WHERE name='Ball'), 1, 'This product SUCKS!', 'This thing literally exploded when I used it.', '2021-10-07 10:00:00' ),
    ((SELECT id FROM Users WHERE email='natty@gmail.com'), (SELECT id FROM Product WHERE name='Ball'), 5, 'This product is AMAZING!', 'This thing literally saved my marriage.', '2021-10-08 10:00:00' ),
    ((SELECT id FROM Users WHERE email='natty@gmail.com'), (SELECT id FROM Product WHERE name='Ball'), 3, 'Meh it was okay', 'It worked for like 3 days and then broke', '2021-10-08 10:00:00' );