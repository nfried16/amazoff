...
const ReviewCard = props => {
    ...
    return (
        <div style={{ width: '100%', marginBottom: '2vh', display: 'flex', flexDirection: 'column', borderStyle: 'solid', borderWidth: '1px', borderRadius: '1px', padding: '20px', background: '#F5F6F8', wordBreak: 'break-word', position: 'relative'}}>
