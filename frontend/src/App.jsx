...
function App() {
	...
	return (
		<Router>
			<Route path='/(home|cart|user|product|order|search|products|orders|fulfill|reviews)' component={NavBar} />
			<Switch>
				...
				<ProtectedRoute exact auth={auth} path='/reviews' component={MyReviews} />
